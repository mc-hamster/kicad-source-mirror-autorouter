...
tangent/acute-room locator policy remains open.
...
The complete native autorouter suite now has **206
...
free-drill regions and any-angle multilayer rooms have been activated. The full
reference tangent/acute-room locator corner policy, final source decision-stream
agreement, and broad-board qualification remain open.
