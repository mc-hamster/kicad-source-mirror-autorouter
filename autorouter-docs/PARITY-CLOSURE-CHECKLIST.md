...
shove, layer-specific padstack shapes/clearance classes, host capture of complete
configured non-through ViaRules, via movement optimization, and true parallel
optimizer scheduling remain open. The remaining legacy visibility/raster
fallback still uses compatibility cost units.
