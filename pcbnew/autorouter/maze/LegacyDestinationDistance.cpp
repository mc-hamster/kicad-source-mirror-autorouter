...
void LEGACY_DESTINATION_DISTANCE::Configure( const AUTOROUTER_SETTINGS& aSettings,
...
void LEGACY_DESTINATION_DISTANCE::Join( const ROUTER_BOX& aBox, int aLayer )
{
...
double LEGACY_DESTINATION_DISTANCE::Calculate( const ROUTER_POINT& aPoint, int aLayer ) const
{
    if( !m_settings )
